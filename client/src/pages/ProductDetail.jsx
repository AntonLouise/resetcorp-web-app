...
const ProductDetail = () => {
  ...
  // Only render the background container after loading is false and product is available
  if (!loading && product) {
    return (
      <div style={{ 
        minHeight: '100vh',
        ...
        >
          <span style={{ fontSize: '2rem', color: '#6c757d' }} className="material-symbols-outlined">arrow_back</span>
        </button>
        <div style={{ 
          maxWidth: '1200px', 
          margin: '0 auto', 
